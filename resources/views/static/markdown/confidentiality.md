...
Nous pouvons partager des informations avec des tiers juridiques afin de répondre à toute demande juridique, administrative, légale. Nous pouvons également partager des informations avec des tiers juridiques comme constituant de nos droits.

### Service des tiers

Toute interaction avec des services proposés par des tiers par le biais de nos Services implique directement leur propre Politique de confidentialité. Nous déclinons toutes responsabilités à propos de la Politique de ces tiers.

### Conservation des informations

De manière générale, nous conservons les informations durant toute la durée du compte utilisateur, nécessaires pour nos Services notamment pour les fonctionnalités du site. Vous convenez que nous pouvons conserver et/ou partager les informations en cas de signalement ou non respect de nos Conditions générales d'utilisation ou pour toute raison juridique, administrative, ou légale.

#### Contenu visible par les utilisateurs

Le Contenu visible par les autres membres de la communauté peut être enregistré de différentes façon et visible par des personnes extérieures.

### Sécurité des informations

Nous mettons tous les moyens en notre possession pour garantir la sécurité des Services et des informations collectées.

### Contrôler vos informations

#### Mise à jour de vos informations

Vous avez la possibilité de mettre à jour ou supprimer certaines de vos informations directement via votre compte.
