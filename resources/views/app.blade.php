...
<body class="flex flex-col items-center justify-center antialiased font-medium transition-colors duration-150 bg-background-default text-on-background-default" data-theme="arc-light">
    @inertia
</body>
