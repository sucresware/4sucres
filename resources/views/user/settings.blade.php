                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body dimmed-border-bottom">
                        <div class="form-group row">
                            <label for="sidebar" class="col-form-label col-md-3">Position de la barre latérale</label>
                            <div class="col-md-9 row pl-4 pl-md-0 pr-0">
                                <div class="custom-control custom-radio col mb-3">
                                ...
                                <div class="custom-control custom-radio col pr-0">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="stickers" class="col-form-label col-md-3">Adapter la taille des stickers Risibank au texte</label>
                            <div class="col-md-9 row pl-4 pl-md-0 pr-0">
                                <div class="custom-control custom-radio col mb-3">
