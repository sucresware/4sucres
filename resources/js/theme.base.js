const TInput = {
    fixedClasses: "w-full px-3 py-3 text-sm leading-tight bg-white border rounded-md appearance-none focus:outline-none focus:shadow-outline",
...
const TButton = {
    ...
    classes: "text-center text-white bg-brand-500 hover:bg-brand-600 focus:border-brand-700 active:bg-brand-700 px-3 py-2",
    variants: {
        secondary: "text-center bg-gray-300 hover:bg-gray-400 focus:border-gray-500 active:bg-gray-500 px-3 py-2",
        sidebar: "mx-auto flex text-gray-300 items-center justify-center w-10 h-10 mr-2 md:mr-0 md:mb-2 bg-gray-800 rounded-md hover:bg-gray-900 focus:text-white focus:bg-brand-500 focus:outline-none",
