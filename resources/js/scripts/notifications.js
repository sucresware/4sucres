...
class NotificationHandler {
  ...
  updateHtml(notification) {
    ...
    $(this.options.genericNotificationSelector).html(getMarkup('fa-bell'));

    if (isPrivate) {
      $(this.options.privateMessageNotificationSelector).html(getMarkup('fa-envelope'));
    }
  }
  ...
  register() {
    ...
    Echo.echo.private(`App.Models.User.${user.id}`).notification((notification) => {
