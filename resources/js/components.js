...
const TButton = {
  fixedClasses:
    'focus:outline-none focus:shadow-outline inline-block transition-all ease-in-out duration-150 text-sm font-medium',
  classes:
  ...
  variants: {
    ...
    large:
      'text-center text-white bg-brand-500 hover:bg-brand-600 focus:border-brand-700 active:bg-brand-700 px-4 py-3 text-base rounded-button',
